 ...
 ****
  ...
  ****
  ...
  - 해결방안
    ...
    그래서 아래와 같이 텍스트필드와 툴바의 간격을 수정해보았다.   
    우선 텍스트필드가 오토레이아웃이 모호했던건 leading/trailing/top/bottom에 대해 마진이 있었는데 사이즈가 별도로 주어지지 않았었다. 이 부분은 우선 기준점인 leading과 top/bottom의 마진만 설정해주고 필드의 넓이는 해당 뷰와 매칭하여 뷰의 현재사이즈의 0.7 multiplier(배수)를 설정하여 어느 기기에서도 넓이는 동일할 수 있게 보이도록 해결하였다.   
    <img width="257" alt="스크린샷 2021-04-26 오전 10 45 46" src="https://user-images.githubusercontent.com/72292617/116018233-93c13380-a67c-11eb-98ec-a1fac108c94c.png">   

    그 후 툴바가 기기마다 간격이 이상했던건 각 툴바 버튼의 사이즈가 있고 그 사이 flexible space가 존재하는데 여기서 툴바의 버튼 사이즈를 지정해줘버리니까 각 시뮬레이터 기기마다 전체 뷰 사이즈가 다른데 해당 버튼 사이즈를 고집하려고 하니 간격이 이상하게 나타났던것이다. 이에 버튼 사이즈대신 간격 사이즈를 주어 조정하였다.   

    결론적으로 모호한 오토레이아웃을 수정한 화면은 아래와 같다.   
    <img width="300" alt="스크린샷 2021-04-26 오전 10 47 11" src="https://user-images.githubusercontent.com/72292617/116018318-c23f0e80-a67c-11eb-803d-6f4b34c25bc3.png">   
    이후 LLDB paltrace 명령어를 통해 뷰 디버깅을 하여도 모호한 오토레이아웃을 찾을 수 없으니 정확하게 해결이 되었다.
